...
int main(){
    ...
    stinger::Image1D<T, CL_R, CL_FLOAT, CL_MEM_READ_ONLY>ImageA(A);
    stinger::Image1D<T, CL_R, CL_FLOAT, CL_MEM_READ_ONLY>ImageB(B);
    stinger::Image1D<T, CL_R, CL_FLOAT, CL_MEM_WRITE_ONLY>ImageC(C);
    ImageA.ToGPU();
    ImageB.ToGPU();
