; ModuleID = 'imagef_sampler.orig.bc'
source_filename = "imagef_sampler.cl"
...
define amdgpu_kernel void @Filter(%opencl.image2d_ro_t addrspace(2)*, %opencl.image2d_ro_t addrspace(2)*, %opencl.image2d_wo_t addrspace(2)*) local_unnamed_addr #0 !kernel_arg_addr_space !3 !kernel_arg_access_qual !4 !kernel_arg_type !5 !kernel_arg_base_type !5 !kernel_arg_type_qual !6 !kernel_arg_name !7 {
  ...
  %11 = tail call <4 x float> @_Z11read_imagef14ocl_image2d_ro11ocl_samplerDv2_i(%opencl.image2d_ro_t addrspace(2)* %0, %opencl.sampler_t addrspace(2)* %10, <2 x i32> %9) #6
  %12 = tail call %opencl.sampler_t addrspace(2)* @__translate_sampler_initializer(i32 18) #5
  %13 = tail call <4 x float> @_Z11read_imagef14ocl_image2d_ro11ocl_samplerDv2_i(%opencl.image2d_ro_t addrspace(2)* %1, %opencl.sampler_t addrspace(2)* %12, <2 x i32> %9) #6
...
declare <4 x float> @_Z11read_imagef14ocl_image2d_ro11ocl_samplerDv2_i(%opencl.image2d_ro_t addrspace(2)*, %opencl.sampler_t addrspace(2)*, <2 x i32>) local_unnamed_addr #2
