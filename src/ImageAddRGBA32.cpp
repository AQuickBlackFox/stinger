...
int main(){
    ...
    stinger::Image2D<T, CL_RGBA, CL_UNSIGNED_INT32, CL_MEM_READ_ONLY>ImageA(A);
    stinger::Image2D<T, CL_RGBA, CL_UNSIGNED_INT32, CL_MEM_READ_ONLY>ImageB(B);
    stinger::Image2D<T, CL_RGBA, CL_UNSIGNED_INT32, CL_MEM_WRITE_ONLY>ImageC(C);
    ImageA.ToGPU();
    ImageB.ToGPU();
