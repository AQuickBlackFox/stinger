...
; BB#0:
	...
	s_and_b32 s10, s22, 0xffff
	s_mul_i32 s8, s8, s10
	v_add_i32_e32 v0, vcc, s8, v0
	v_add_i32_e32 v8, vcc, s28, v0
	s_load_dwordx8 s[20:27], s[20:21], 0x0
	s_waitcnt vmcnt(0)
	v_mul_lo_i32 v0, s9, v2
	v_add_i32_e32 v0, vcc, v1, v0
	v_add_i32_e32 v9, vcc, s30, v0
	s_waitcnt lgkmcnt(0)
	image_load v[0:3], v[8:9], s[0:7] dmask:0xf unorm
	image_load v[4:7], v[8:9], s[12:19] dmask:0xf unorm
	s_waitcnt vmcnt(0)
	v_add_f32_e32 v3, v3, v7
	v_add_f32_e32 v2, v2, v6
	v_add_f32_e32 v1, v1, v5
	v_add_f32_e32 v0, v0, v4
	image_store v[0:3], v[8:9], s[20:27] dmask:0xf unorm
	s_endpgm
.Lfunc_end0:
