...
int main(){
    ...
    stinger::Image2D<T, CL_RGB, CL_UNORM_SHORT_565, CL_MEM_READ_ONLY>ImageA(A);
    stinger::Image2D<T, CL_RGB, CL_UNORM_SHORT_565, CL_MEM_READ_ONLY>ImageB(B);
    stinger::Image2D<T, CL_RGB, CL_UNORM_SHORT_565, CL_MEM_WRITE_ONLY>ImageC(C);
    ImageA.ToGPU();
    ImageB.ToGPU();
