...
int main(){
    ...
    stinger::Image2D<T, CL_R, CL_UNORM_INT8, CL_MEM_READ_ONLY>ImageA(A);
    stinger::Image2D<T, CL_R, CL_UNORM_INT8, CL_MEM_READ_ONLY>ImageB(B);
    stinger::Image2D<T, CL_R, CL_UNORM_INT8, CL_MEM_WRITE_ONLY>ImageC(C);
    ImageA.ToGPU();
    ImageB.ToGPU();
